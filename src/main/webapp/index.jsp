...
<body>
    <div class="container">
        ...
        <div class="section">
            <h2>Summary</h2>
            <p>A brief summary of your professional background, skills, and key achievements.</p>
        </div>
        <div class="section">
        ...
        <div class="section">
            ...
            <ul>
                <li>
                    <strong>Degree</strong> - Institution Name (Graduation Year)
                    <br>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>A Np's Shopping Website</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">A Np's Shop</a>
    ...
    <!-- Main Content -->
    <div class="container">
        <h1 class="text-center mb-4">Welcome to A Np's Shopping Website</h1>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>&copy; 2025 A Np's Shop. All rights reserved.</p>
    </div>
